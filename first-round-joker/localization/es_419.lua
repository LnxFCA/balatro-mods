return {
    misc = {
        dictionary = {
            ...
            frj_save_joker_d = "Guarda la carta Joker seleccionada entre partidas, asegurando que esté disponible al reiniciar el juego.",

            frj_base_price = "Usar precio base del Joker",
            frj_base_price_d = "Configura el precio de la carta Joker a su valor original, sin tomar en cuenta los costos adicionales de los efectos o ediciones aplicadas.",
